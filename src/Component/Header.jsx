  ...
  return (
    <div className="h-20 z-50 fixed top-0 left-0 right-0 sm:h-16 md:h-20 lg:h-24 bg-gray-700 flex items-center justify-between gap-4 px-1 sm:px-6 md:px-8 lg:px-10">
      ...
      <div className="flex items-center border-2 border-white rounded-lg">
        ...
        <input
          className="text-base sm:text-lg md:text-xl lg:text-2xl rounded-md mr-10 font-semibold text-white bg-transparent px-2 py-1 sm:px-3 outline-none w-40 sm:w-48 md:w-64"
          type="text"
